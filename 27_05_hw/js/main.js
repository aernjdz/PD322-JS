...
class Circle {
    ...
    toString() {
        return `<div style="background: green; height:170px; width:170px; border-radius:50%;display: flex; align-items: center;justify-content: center; ">
            <p style="text-align: center; color:white; font-weight: bold;"> Radius: ${this.r}<br>Diameter: ${this.diameter}<br> Area: ${this.circleArea()}
...
let test = new CssClass("test")


// let c = new CssClass('test');
test.setStyle('font-size', '1em');
test.setStyle('color', 'white');
test.setStyle('background', 'violet');
test.removeStyle('background');
document.write(test.getCss());
